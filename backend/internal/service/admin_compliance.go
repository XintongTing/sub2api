...
const (
	...
	AdminComplianceAckPhraseZH    = "我已阅读、理解并同意 OneAPI 部署与运营合规承诺"
	AdminComplianceAckPhraseEN    = "I have read, understood, and agree to the OneAPI Deployment and Operation Compliance Commitment"
