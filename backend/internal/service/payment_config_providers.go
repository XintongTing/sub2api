...
var providerSensitiveConfigFields = map[string]map[string]struct{}{
	...
	payment.TypePayoneer:  {"clientsecret": {}, "webhooksecret": {}},
	payment.TypePayPal:    {"clientsecret": {}},
	payment.TypeSunrate:   {"signaturekey": {}},
}
...
var providerPendingOrderProtectedConfigFields = map[string]map[string]struct{}{
	...
	payment.TypePayoneer:  {"clientid": {}, "clientsecret": {}, "webhooksecret": {}, "environment": {}, "currency": {}, "apibase": {}, "createpath": {}, "querypath": {}},
	payment.TypePayPal:    {"clientid": {}, "clientsecret": {}, "webhookid": {}, "environment": {}, "currency": {}, "apibase": {}},
	payment.TypeSunrate:   {"merchantid": {}, "signaturekey": {}, "environment": {}, "currency": {}, "apibase": {}, "filters": {}},
}
...
var validProviderKeys = map[string]bool{
	payment.TypeEasyPay: true, payment.TypeAlipay: true, payment.TypeWxpay: true, payment.TypeStripe: true, payment.TypeAirwallex: true, payment.TypePayoneer: true, payment.TypePayPal: true, payment.TypeSunrate: true,
}
