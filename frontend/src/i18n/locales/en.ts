export default {
  ...
  admin: {
    ...
    scheduledTests: {
      ...
      addPlan: 'Add Plan',
      editPlan: 'Edit Recharge Amount',
      deletePlan: 'Delete Recharge Amount',
      model: 'Model',
    ...
    settings: {
      ...
      payment: {
        ...
        field_paypalApiBaseHint: 'Sandbox defaults to https://api-m.sandbox.paypal.com and live defaults to https://api-m.paypal.com. Override only when PayPal gives your merchant account a different endpoint.',
        ...
        paypalWebhookHint: 'Configure the following URL as the PayPal webhook endpoint, subscribe to CHECKOUT.ORDER.APPROVED, and paste the PayPal Webhook ID into this provider.',
        sunrateWebhookHint: 'Provide this URL to SUNRATE as the asynchronous backURL. The system verifies the signature, credits the order, and returns OK.',
        field_merchantId: 'Merchant ID',
        field_signatureKey: 'Signature Key',
        field_filters: 'Cashier payment filters',
  ...
  payment: {
    ...
    noPlans: 'No recharge amounts available',
    ...
    admin: {
      ...
      planName: 'Recharge Amount Name',
      planDescription: 'Recharge Description',
      createPlan: 'Create Recharge Amount',
      editPlan: 'Edit Recharge Amount',
      deletePlan: 'Delete Recharge Amount',
      deletePlanConfirm: 'Are you sure you want to delete this recharge amount?',
      ...
      plansPageTitle: 'Recharge Amount Settings',
      plansPageDesc: 'Manage subscription plan configuration',
      tabPlanConfig: 'Recharge Amount Configuration',
