...
const agreementVersion = ref<string>('customer-registration-notice-2026-06-08')
...
onMounted(async () => {
  ...
  if (registerDataStr) {
    try {
      ...
      agreementAccepted.value = registerData.agreement_accepted === true
      agreementVersion.value = registerData.agreement_version || agreementVersion.value
  ...
  try {
    ...
    if (isPendingOAuthFlow()) {
      ...
      await authStore.register({
        ...
        agreement_version: agreementVersion.value,
