# OneAPI Deployment Files

This directory contains files for deploying OneAPI on Linux servers.
...
OneAPI supports three methods to connect to Gemini:
...
OneAPI supports TLS fingerprint simulation to make requests appear as if they come from the official Claude CLI (Node.js client).
